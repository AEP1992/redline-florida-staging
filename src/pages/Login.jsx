...
export default function Login({ onLogin }) {
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      if (email === 'geoff.mishkin.florida@redlinegearcleaning.com' && password === 'Welcome@123') {
        onLogin({ email, name: 'GeoffMishkin', role: 'ROLE_FRANCHISE' });
      } else {
    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden md:flex flex-1 bg-[#1a2a4a] items-center justify-center relative overflow-hidden">
        ...
        <div className="text-center z-10 px-12">
          ...
          <p className="text-white/40 text-sm mt-2">Florida Franchise — Staging Environment</p>
        </div>
      </div>
    </div>
  );
